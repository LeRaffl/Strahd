# Termine — Fluch des Strahd

*Geplante und vorgemerkte Sessions. Regeln dazu siehe [`session-zero.md`](session-zero.md#termine).*

## Format-Reminder

- **Lange Session (Sonntag):** 15 Uhr eintrudeln → 16 Uhr Spielstart, hartes Ende 21 Uhr, ca. 4–5h Spielzeit. Essen bei der Halbzeit, Bestellung **vorher** abstimmen.
- **Kurze Session (unter der Woche):** 18 Uhr eintrudeln → 18:30 Uhr Spielstart, ca. 2h. Kein gemeinsames Essen — vorher essen.
...
- **2026-05-12 (Di):** Session Zero — Orga, Do's/Don'ts, X-Card → [`session-zero.md`](session-zero.md)
