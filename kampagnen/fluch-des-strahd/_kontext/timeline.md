...
*Wird automatisch nach jeder Session ergänzt.*

---

## Vor der Kampagne

### Apfelried-Verbindungen
- Nia Sommerfeld lebt und arbeitet als wandernde Physiotherapeutin aus **Apfelried** heraus.
- Familie Sommerfeld (Hanna, Bert, Timo) und ihr Kund:innen-Kreis (Greta Holunder, Oskar Bram) bilden Nias Heimat-Anker.
- Nia hat das Dorf bewusst verlassen — kein Trauma, sondern ein Impuls "raus und Welt kennenlernen".
...
- Nia nimmt ihn mit. Alberich ist dabei.
- Die Gruppe versucht seitdem, die Verwandlung rückgängig zu machen.

### Thorin trifft Moxie
- **Thorin** (Barbar, Nordbewohner) zog aus seinem Stamm aus, um sich seinen höchsten Kriegerrang zu verdienen.
...
- **Dort beginnt Session 1** von Fluch des Strahd.

---

## Session 001 — 13.05.2026 · Schilfheim → Barovia (Dorf)

### Auftrag in Schilfheim
- **Arigal von und zu Nachtigall** stürmt in die Kneipe "Zum Schilf" und übergibt der Party einen Brief + 100 Goldkronen im Auftrag von **Koljan Indirovic**, Bürgermeister von Barovia.
- Die Adoptivtochter **Irena Koljana** siecht an einer mysteriösen Wunde dahin — die Party soll helfen.
- Arigal warnt vor dem Svalidsch Wald bei Nacht und reitet davon. Das Gold wird eingesteckt → Auftrag gilt als angenommen.
- Mara findet im Gemeinschaftsraum: Metallknopf (Wappen: Pferd + Lanze ohne Reiter) und einen Rubin.

### Svalidsch Wald — Wölfe und das Tor
- Drei Wölfe greifen an. Thorin intimidiert einen zur Flucht. Nia halbiert einen beim Rückzug. Der dritte stirbt unter Alberich + Floris Angriffen.
- Riesiges Steintor mit kopflosen Ritterstatuen — öffnet sich von selbst. Dahinter schließt sich der Nebel sofort. Kein Rückweg erkennbar.
- Im Svalidsch Wald: turmhohe Bäume, gedämpftes Licht, Moxie nimmt den Nebel als gefährlich wahr.

### Leichnam im Wald
- Fauliger Geruch führt vom Weg zu einem zerfetzten Leichnam (Lederkleidung, Maden, Brief in der Hand).
- Thorin erschnüffelt: der Brief riecht anders als der Brief des Bürgermeisters → einer der beiden ist gefälscht oder von anderer Hand.
- Moxie: Todeszeichen deuten auf Untote oder Niedergänger hin.
- *(Der Tote ist Markus, ein Angestellter des Bürgermeisters — das erfährt die Tavernen-Gruppe erst später von Ismag.)*

### Ankunft in Barovia (Dorf)
- Alles verrottet, verrammelt, Kratz- und Feuerspuren. Schloss Ravenloft am Horizont: "wie ein hässliches Neuschwanstein."
